  ...
  <sui-grid class="container">
    <sui-grid-row>
      <sui-grid-column :width="13">
        ...
        <header class="header"> {{ lectureTitle }} </header>
        <markdown-view v-bind:value="message" style="color:#7B1FA2"></markdown-view>
      </sui-grid-column>
  ...
  export default {
    ...
    data () {
      return {
        ...
        selectedImage: '',
        message :
        '##### 자바 언어의 기본 문법과 객체 지향 프로그래밍 개념을 단계별로 정립합니다.'
      }
    },
